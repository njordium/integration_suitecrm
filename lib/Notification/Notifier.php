...
class Notifier implements INotifier {
	...
	public function prepare(INotification $notification, string $languageCode): INotification {
		...
		case 'reminder':
			...
			// If the reminder is for a module we don't render (anything other
			// than Calls or Meetings), $content stays empty and we used to
			// setParsedSubject(''), which produced a blank row in the
			// notification tray. Throwing here tells NC's notification manager
			// to suppress the row entirely, matching the contract for "unknown
			// subject" below.
			if ($content === '') {
				throw new InvalidArgumentException();
			}
