 ...
 *
 * The URL regex mirrors {@see \OCA\SuiteCRM\Reference\RecordUrlParser}
 * on the backend so the reference-provider preview cards and the
 * write-side picker accept the exact same URL shapes.
 *
