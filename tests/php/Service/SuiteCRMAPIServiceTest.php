				...
				'data' => [
					[
						...
						'attributes' => [
							...
							'date_closed' => (new \DateTime('+10 years'))->format('Y-m-d'),
						],
					],
					[
						'id' => 'opp-huge',
				...
				'data' => [
					[
						...
						'attributes' => [
							...
							'probability' => '50',
							'sales_stage' => 'Qualification',
							'date_closed' => (new \DateTime())->format('Y-m-d'),
						],
					],
					[
						'id' => 'opp-far-future',
						'attributes' => [
							...
							'probability' => '50',
							'sales_stage' => 'Qualification',
							'date_closed' => (new \DateTime('+2 years'))->format('Y-m-d'),
						],
					],
					[
						'id' => 'opp-undated',
				...
				'data' => [
					[
						...
						'attributes' => [
							...
							'probability' => '40',
							'sales_stage' => 'Proposal/Price Quote',
							'date_closed' => (new \DateTime('+1 year'))->format('Y-m-d'),
							'currency_symbol' => '$',
						],
					],
				],
